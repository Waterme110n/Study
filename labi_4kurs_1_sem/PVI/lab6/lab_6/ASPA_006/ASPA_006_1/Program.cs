...
internal class Program
{
    ...
    {
        string CS = "Server=WIN-Q0RIPORRGIF\\MSSQLSERVER02; Database=Lab6_Db; Trusted_Connection=true; TrustServerCertificate=Yes";
        ...
        lifeEvents.MapPut("/{id:int:min(1)}", (IRepository repo, int id, LifeEvent newEvent) =>
        {
            ...
            {
                throw new UpdateException($"Failed to update life event with id {id}");
            }
        });

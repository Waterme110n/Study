...
namespace lab4
{
    class Program
    {
        ...
        private static void querySettings(EnigmaSettings e)
        {
            ...
            Console.WriteLine("Type of left Rotor: V");
            Console.WriteLine("Type of middle Rotor: VI");
            Console.WriteLine("Type of right Rotor: VII");
            Console.WriteLine("Type of Reflector: C Dunn");
            Console.WriteLine("Step L-M-R: 1-2-2");
            e.setDefault();
            Console.WriteLine();
        }

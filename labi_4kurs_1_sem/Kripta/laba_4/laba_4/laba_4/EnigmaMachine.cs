...
namespace lab4
{
    class EnigmaMachine
    {
        ...
        private const string rotorL = "ESOVPZJAYQUIRHXLNFTGKDCMWB";
        private const string rotorM = "BDFHJLCPRTXVZNYEIWGAKMUSQO";
        private const string rotorR = "AJDKSIRUXBLHWTMCQGZNPYFVOE";
        ...
        public EnigmaMachine()
        {
            ...
            Rotor rL = new Rotor(rotorL, 'I', "VIII");
            Rotor rM = new Rotor(rotorM, 'E', "II");
            Rotor rR = new Rotor(rotorR, 'Q', "IV");

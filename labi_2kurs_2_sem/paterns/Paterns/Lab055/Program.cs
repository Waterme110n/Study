...
namespace PP055
{
    internal class Program {
        static void Main(string[] args) {
            ...
            {
                IWriter writer = new FileWriter(@"C:\labi_2kurs_2_sem\paterns\Paterns\Lab055\test2.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"C:\labi_2kurs_2_sem\paterns\Paterns\Lab055\test4.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
            ...
            {
                IWriter writer = new FileWriter(@"C:\labi_2kurs_2_sem\paterns\Paterns\Lab055\test12.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecSHA512(rsa);
                string? result = hash.Save("BBBBCCCCC");
            ...
            {
                IWriter writer = new FileWriter(@"C:\labi_2kurs_2_sem\paterns\Paterns\Lab055\test13.txt");
                IWriter rsa = new DecRSA(writer);
                IWriter hash = new DecMD5(rsa);
                string? result = hash.Save("BBBBCCCCC");

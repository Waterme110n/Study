                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            ...
                            // Используем переданное изображение
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 25),
                            Text(food.title, style: TextStyle(color: Colors.black,
                                fontSize: 40,
                                fontFamily: 'Roboto',
                                fontWeight: FontWeight.bold)),
                            Text(food.subtitle.toUpperCase(), style: TextStyle(
                            ...
                            RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: ' Read more',
                                    style: TextStyle(color: Color(0xFFb19df6),
                                        height: 1.5,
                                        fontSize: 15,
                                        fontFamily: 'Roboto',
                                        fontWeight: FontWeight.bold),
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: 'PRO ',
                                        style: TextStyle(color: Color(0xffd99320),
                                            height: 1.5,
                                            fontSize: 15,
                                            fontFamily: 'Roboto',
                                            fontWeight: FontWeight.bold),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text('DELIVERY COST'.toUpperCase(),
                                          style: TextStyle(
                                              color: Color(0xFFcccccc),
                                              fontSize: 15,
                                              fontFamily: 'Roboto',
                                  ...
                                  Column(
                                    children: [
                                      Text('DELIVERY TIME'.toUpperCase(),
                                          style: TextStyle(
                                              color: Color(0xFFcccccc),
                                              fontSize: 15,
                                              fontFamily: 'Roboto',
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  foodProvider.addToCart(food);
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text(
                                        'Added to cart: ${food.title}')),
                                  );
                                },
                                child: Align(
                                  alignment: Alignment.center,
                                  child: Text(
                                    'Order for ' + food.price,
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 23,
                                      fontFamily: 'Roboto',

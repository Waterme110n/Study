...
// in lab11/test/tests/tests.dart.
...
import 'package:lab11/FoodItem.dart' as _i8;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockFoodItem extends _i1.Mock implements _i8.FoodItem {
  MockFoodItem() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  bool get isHot =>
      (super.noSuchMethod(Invocation.getter(#isHot), returnValue: false)
          as bool);

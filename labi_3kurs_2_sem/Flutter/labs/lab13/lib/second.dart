                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 25),
                        Text(foodItem.title, style: TextStyle(color: Colors.black,  fontSize: 40, fontFamily: 'Roboto',fontWeight:  FontWeight.bold)),
                        Text((foodItem.subtitle).toUpperCase(), style: TextStyle(color: Color(0xFFcccccc),  fontSize: 15, fontFamily: 'Roboto',fontWeight:  FontWeight.bold)),
                        SizedBox(height: 20),
                        Container(
                          width: 1000,
                          height: 1,

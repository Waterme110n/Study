                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(imageUrl),// Замените на реальное изображение блюда
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(subtitle, style: TextStyle(color: Color(0xFFcccccc),  fontSize: 15, fontFamily: 'Roboto',fontWeight:  FontWeight.bold)),
                        SizedBox(height: 20),
                        Container(
                          width: 1000,
                          height: 1,
...
void main() {
  runApp(MaterialApp(
    ...
    home: FoodDetailScreen(title: "",subtitle: "",imageUrl: "",price: "",),
  ));
}